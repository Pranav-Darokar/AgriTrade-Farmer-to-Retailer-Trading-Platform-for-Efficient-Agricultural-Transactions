                    ...
                    {isEditing ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2 space-y-2">
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Precise Location (for distance calculation)</label>
                                <div className="flex gap-4 items-center">
                                    <div className="flex-1 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border border-gray-200 dark:border-gray-600 text-xs text-gray-500 flex justify-between">
                                        <span>Lat: {formData.latitude || 'Not set'}</span>
                                        <span>Lon: {formData.longitude || 'Not set'}</span>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={() => {
                                ...
                                <p className="text-[10px] text-gray-400 italic">This is required for accurate shipping and perishability checks.</p>
                            </div>
                        </div>
                    ) : (
